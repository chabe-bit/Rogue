...
int main(int argc, char *argv[])
{
    ...
    asset_t blank_screen_asset = IdealLoadAsset("../assets/blank_screen.png");
    InitializeAssetToRender(&blank_screen_asset, 0, 0, ASPECT_WIDTH, ASPECT_HEIGHT);

    asset_t title_screen_asset = IdealLoadAsset("../assets/blank_screen.png");
    InitializeAssetToRender(&title_screen_asset, 0, 0, ASPECT_WIDTH, ASPECT_HEIGHT);
    
    asset_t new_game_command_menu = IdealLoadAsset("../assets/new_game_screen.png");
    ...
    asset_t new_game_asset = IdealLoadAsset("../assets/new_game_screen.png");
    InitializeAssetToRender(&new_game_asset, 0, 0, new_game_asset.w, new_game_asset.h); 

    asset_t dialogue_box_asset = IdealLoadAsset("../assets/ui/dialogue_box.png");
...
#define RIGHT_CURSOR    3
    ...
    asset_t gold_coin_count_bg_asset = IdealLoadAsset("../assets/ui/gold_coin_count_background.png");
    ...
    {
        character_creation_screen.info[i].asset = IdealLoadAsset(class_files[i]);
